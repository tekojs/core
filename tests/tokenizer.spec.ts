...
test('tokenize should parse escaped expression', () => {
...
test('tokenize should parse raw expression', () => {
...
test('tokenize should parse if directive', () => {
...
test('tokenize should parse each directive', () => {
...
test('tokenize should parse component directive', () => {
